...
"$tool_root/python/bin/python" -m pip install --disable-pip-version-check --no-cache-dir "ruff==0.9.10" "mypy==1.15.0" "pip-audit==2.10.1" "semgrep==1.174.0" "tomli==2.0.1" -r requirements/test.txt
