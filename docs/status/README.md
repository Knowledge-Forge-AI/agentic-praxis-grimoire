...
- [`00142 — APG93 v0.6 Public GitHub and PyPI Publication Exit`](2026/08/21/00142-apg93-v0-6-public-github-and-pypi-publication-exit.md)
- [`00143 — APG94 v0.7 Embeddable Toolkit Architecture Exit`](2026/08/21/00143-apg94-v0-7-embeddable-toolkit-architecture-exit.md)
- [`00144 — APG95 Go Reporting Library Vertical Slice Exit`](2026/08/21/00144-apg95-go-reporting-library-vertical-slice-exit.md)
- [`00145 — APG96 Go CLI Foundation and Python Report Migration Bridge Exit`](2026/08/21/00145-apg96-go-cli-foundation-and-python-report-migration-bridge-exit.md)
- [`00146 — APG97 Deterministic Skill Context Bundles and Agent-Scoped Materialization Exit`](2026/08/22/00146-apg97-deterministic-skill-context-bundles-and-agent-scoped-materialization-exit.md)
- [`00147 — APG98 Portable Environment Snapshots and Resolution Exit`](2026/08/22/00147-apg98-portable-environment-snapshots-and-resolution-exit.md)
- [`00148 — APG99 Structural Hotspot Analyzer Exit`](2026/08/22/00148-apg99-structural-hotspot-analyzer-exit.md)
- [`00149 — APG100 Complete Go Strangler and Multi-Ecosystem Distribution Exit`](2026/08/22/00149-apg100-complete-go-strangler-and-multi-ecosystem-distribution-exit.md)
- [`00150 — APG101 Human Documentation and README Restructuring Exit`](2026/08/22/00150-apg101-human-documentation-restructuring-exit.md)
...
- [`00155 — APG110 v0.9.0 CI Conformance Qualification Exit`](2026/09/06/00155-apg110-v090-ci-conformance-qualification-exit.md)
- [`00156 — APG111 v0.9.0 CI Conformance Qualification Remediation Exit`](2026/09/06/00156-apg111-v090-ci-conformance-remediation-exit.md)
- [`00157 — APG112 v0.9.0 XO Compatibility Exit`](2026/09/06/00157-apg112-v090-xo-compatibility-exit.md)
- [`00158 — APG113 v0.9.0 XO Compatibility Exit`](2026/09/06/00158-apg113-v090-xo-compatibility-exit.md)
- [`00159 — APG114 v0.9.0 Integrated Source Qualification Exit`](2026/09/06/00159-apg114-v090-integrated-source-qualification-exit.md)
- [`00160 — APG115 v0.9.0 release source preparation exit`](2026/09/07/00160-apg115-v090-release-source-preparation-exit.md)
