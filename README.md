...
[ADR 0011](docs/adr/2026/07/0011-v0-3-workflow-synthesis-and-modular-guidance-architecture.md).
...
APG17 accepts
[ADR 0013](docs/adr/2026/07/0013-repository-guidance-synthesis-and-migration-dispositions.md)
...
[ADR 0012](docs/adr/2026/07/0012-language-profile-contract-and-warning-levels.md),
...
[ADR 0015](docs/adr/2026/07/0015-semantic-phase-identity-and-record-finalization.md).
...
[ADR 0016](docs/adr/2026/07/0016-nix-and-relational-engine-profile-ownership.md)
...
reduction. The [guidance-migration proposal](docs/v0-3-guidance-migration-proposal.md)
...
before any later cutover. The [v0.3 release-scope ledger](docs/v0-3-release-scope-closure.md)
...
APG24 accepts
[ADR 0019](docs/adr/2026/07/0019-v0-3-release-distribution-and-variable-skill-set-lifecycle.md),
